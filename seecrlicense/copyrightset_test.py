        ...
        [
            {
                ...
                "name": "Seecr",
                "url": "http://seecr.nl",
                "text": "some optional text" + 10 * " and some more",
            },
            {
                "years": [2007, 2009, 2008],
                "name": "Seek You Too",
                "url": "http://cq2.nl",
            },
        ]
...
def test_merge():
    ...
    copyrightSet2 = CopyrightSet(
        [
            ...
            },
            {
                "years": [2010],
                "name": "Seek You Too",
                "url": "http://seekyoutoo.nl",
                "text": "will be renamed in 2011",
            },
    ...
    assert (
        copyrightSetMerged.asCopyrightLines()
        == "\
